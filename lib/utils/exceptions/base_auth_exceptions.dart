...
/// --- Custom Exception Class to Handle Various Authentication-Related Errors --- ///
class EBaseAuthException implements Exception {
  /// --- The Error Code Associated With The Exception --- ///

  final String code;

  /// --- Constructor That Takes on Error Code --- ///
  EBaseAuthException(this.code);

  /// --- Get The Corresponding Error Message Based on The Error Code --- ///
  String get message {
    switch (code) {
      case EText.emailTaken:
        return EText.emailTakenMessage;
      case EText.emailInvalid:
        return EText.emailInvalidMessage;
      case EText.passwordWeak:
        return EText.passwordWeakMessage;
      case EText.userDisabled:
        return EText.userDisabledMessage;
      case EText.userNotFound:
        return EText.userNotFoundMessage;
      case EText.passwordIncorrect:
        return EText.passwordIncorrectMessage;
      case EText.verificationCodeInvalid:
        return EText.verificationCodeInvalidMessage;
      case EText.verificationIdInvalid:
        return EText.verificationIdInvalidMessage;
      case EText.quotaExceeded:
        return EText.quotaExceededMessage;
      case EText.emailExists:
        return EText.emailExistsMessage;
